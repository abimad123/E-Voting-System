        ...
        <div className="bg-white dark:bg-[#1a1a1a] rounded-xl shadow-md border-l-4 border-[#0B2447] dark:border-yellow-400 p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 transition-colors duration-200">
            ...
            <div className="flex items-center gap-5">
                ...
                <div className="w-20 h-20 rounded-full overflow-hidden bg-gray-200 dark:bg-zinc-800 border-2 border-gray-100 dark:border-zinc-700 shadow-sm flex items-center justify-center text-3xl text-gray-400 font-bold">
                    {avatarSrc ? (
                        <img src={avatarSrc} alt="admin avatar" className="w-full h-full object-cover" />
                    ) : (
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                <button
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-bold text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 dark:bg-zinc-800 dark:text-gray-200 dark:border-zinc-700 dark:hover:bg-zinc-700 rounded-lg shadow-sm transition-colors"
                >
                    <ArrowLeft size={18} />
                    Back to Dashboard
                </button>
            ...
            <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="p-6">
                        <form onSubmit={handleCreateElection} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="md:col-span-2">
                                <label className="block text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 mb-1">Title</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 mb-1">Start Time</label>
                            ...
                            <div>
                                <label className="block text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 mb-1">End Time</label>
                                <div className="relative">
                                    <input
                                        type="datetime-local"
                                        className="w-full px-3 py-2 bg-white dark:bg-[#111] border border-gray-300 dark:border-zinc-700 rounded-lg text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-[#0B2447] dark:focus:ring-yellow-400 focus:outline-none"
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                ...
                                />
                                <label htmlFor="isPublic" className="text-sm text-gray-700 dark:text-gray-300 flex items-center gap-2">
                ...
                <div className="bg-white dark:bg-[#1a1a1a] rounded-xl shadow-md border border-gray-200 dark:border-zinc-800 overflow-hidden">
                    ...
                    <div className="p-4 space-y-4">
                        {elections.length === 0 ? (
                            <p className="text-center text-sm text-gray-500 py-4">No active elections found.</p>
                        ) : (
                            elections.map((e) => {
                                ...
                                return (
                                    <div key={e._id} className="border border-gray-200 dark:border-zinc-700 rounded-lg p-4 bg-white dark:bg-[#151515] hover:border-gray-300 dark:hover:border-zinc-600 transition-colors">
                                        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                                            <div className="space-y-1">
                                                <h3 className="font-bold text-lg text-gray-900 dark:text-white">{e.title}</h3>
                                        ...
                                        <div className="pt-3 mt-3 border-t border-gray-100 dark:border-zinc-800">
                                            <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-2">ADD CANDIDATE</label>
                                            <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="px-4 py-1.5 text-sm font-semibold text-white bg-blue-600 rounded hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 transition-colors"
                                                >
                                                    Add
                                                </button>
                                            </div>
                ...
                <div className="bg-white dark:bg-[#1a1a1a] rounded-xl shadow-md border border-gray-200 dark:border-zinc-800 overflow-hidden">
                    ...
                    <div className="p-4 space-y-2">
                        {archived.length === 0 ? (
                            <p className="text-center text-sm text-gray-500 py-4">No archived elections.</p>
                        ) : (
                            archived.map((e) => (
                                <div key={e._id} className="flex items-center justify-between p-3 border border-gray-100 dark:border-zinc-800 rounded bg-gray-50 dark:bg-[#151515]">
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-500 dark:text-gray-500 truncate max-w-xs">{e.description}</div>
                                    </div>
                                    <button
                                        onClick={() => handleUnarchive(e._id)}
                                        className="flex items-center gap-1 px-3 py-1 text-xs font-medium text-green-600 border border-green-200 rounded hover:bg-green-50 dark:text-green-400 dark:border-green-900/50 dark:hover:bg-green-900/20 transition-colors"
                                    >
                ...
                <div className="bg-white dark:bg-[#1a1a1a] rounded-xl shadow-md border border-gray-200 dark:border-zinc-800 overflow-hidden">
                    ...
                    <div className="overflow-x-auto max-h-[400px] overflow-y-auto">
                        {pendingUsers.length === 0 ? (
                            <p className="text-center text-sm text-gray-500 py-8">No pending verifications.</p>
                        ) : (
                                    ...
                                    {pendingUsers.map((u) => (
                                        <tr key={u._id} className="hover:bg-gray-50 dark:hover:bg-[#222] transition-colors">
                                            <td className="px-3 py-3">
                                                ...
                                                <div className="text-gray-500 dark:text-gray-500 truncate max-w-[100px]">{u.email}</div>
                                                <div className="mt-1 text-[10px] bg-gray-100 dark:bg-zinc-800 px-1 py-0.5 rounded inline-block text-gray-600 dark:text-gray-400">{u.idType || "N/A"}</div>
                                            </td>
                                            <td className="px-3 py-3">
                                                {u.idDocPath ? (
                                                    <a href={`${API_BASE}${u.idDocPath}`} target="_blank" rel="noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1">
                                                        <FileText size={12}/> View
                                                    </a>
                                                ) : <span className="text-gray-400">Missing</span>}
                                            </td>
                                            <td className="px-3 py-3 text-right space-y-1">
                                                <button onClick={() => handleVerifyUser(u._id, "approve")} className="w-full flex items-center justify-center gap-1 px-2 py-1 bg-green-50 text-green-700 hover:bg-green-100 dark:bg-green-900/30 dark:text-green-400 dark:hover:bg-green-900/50 rounded transition-colors">
                                                    <CheckCircle size={12}/> Approve
                                                </button>
                                                <button onClick={() => handleVerifyUser(u._id, "reject")} className="w-full flex items-center justify-center gap-1 px-2 py-1 bg-red-50 text-red-700 hover:bg-red-100 dark:bg-red-900/30 dark:text-red-400 dark:hover:bg-red-900/50 rounded transition-colors">
                ...
                <div className="bg-white dark:bg-[#1a1a1a] rounded-xl shadow-md border border-gray-200 dark:border-zinc-800 overflow-hidden flex flex-col h-[500px]">
                    ...
                    <div className="flex-1 overflow-auto bg-gray-50/50 dark:bg-[#111]">
                        {filteredLogs.length === 0 ? (
                            <p className="text-center text-sm text-gray-500 py-8">No logs match criteria.</p>
                        ) : (
                                    ...
                                    return (
                                        <div key={log._id} className="p-3 hover:bg-white dark:hover:bg-[#1a1a1a] transition-colors">
                                            <div className="flex justify-between items-start mb-1">
                                                <span className="font-bold text-xs text-gray-800 dark:text-gray-200">{log.action}</span>
